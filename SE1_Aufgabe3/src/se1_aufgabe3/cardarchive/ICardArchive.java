...
public interface ICardArchive {
	/**
	 * gibt ein Fach anhand seines Namens zur�ck
	 * 
	 * @param inName
	 * @return IFach
	 */
    ...
    /**
     * Gibt alle registrierten F�cher zur�ck
     * 
    ...
    /**
     * Gibt eine Lernkarte anhand seiner UUID zur�ck
     * 
     * @param inID
